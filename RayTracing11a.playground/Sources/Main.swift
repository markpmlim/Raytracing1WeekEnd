...
public func generateCGImage() -> CGImage? {
    ...
    let materialRight = Lambertian(albedo: color(1.0, 0.0, 0.0))
 
    var object = Sphere(center: point3(-R, 0.0, -1.0), radius: R,
                        material: materialLeft)
    objects.append(object)
    object = Sphere(center: point3(R, 0.0, -1.0), radius: R,
